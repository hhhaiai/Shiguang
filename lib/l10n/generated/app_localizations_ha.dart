...
class AppLocalizationsHa extends AppLocalizations {
  ...
  @override
  String get languageName => 'Hausa';

  @override
  String get languageNameEn => 'Hausa';
  ...
  @override
  String get noContent => 'Babu abun ciki';

  @override
  String get diaryNotFound => 'Ba a samo littafin tarihin ba';

  @override
  String get diaryNotFoundShort => 'Ba a samo rikodin ba';

  @override
  String get aiSummary => 'AI Summary';

  @override
  String get microphoneInterrupted => 'An katse makirufo, an daina yin rikodi.';
  ...
  @override
  String get strikethrough => 'Tashin hankali';

  @override
  String get image => 'Hoto';

  @override
  String get asrUnavailableRecordingActive =>
      'Babu ASR. Rikodi har yanzu yana aiki.';
  ...
  @override
  String get writeYourEntry => 'Rubuta shigarwar ku...';

  @override
  String get writeYourContent => 'Rubuta abubuwan ku...';

  @override
  String microphoneStartFailed(String error) {
    return 'An kasa fara makirufo: _PH_0__';
  }

  @override
  String get microphoneInterruptedRecordingStopped =>
      'An katse makirufo, an daina yin rikodi.';

  @override
  String asrReconnectingError(String error) {
    return 'Sake haɗin ASR: _PH_0__';
  }

  @override
  String imageInserted(String name) {
    return 'An saka hoton: _PH_0__';
  }

  @override
  String voiceError(String error) {
    return 'Kuskuren murya: _PH_0__';
  }

  @override
  String aiServiceUnavailable(String error) {
    return 'Yi haƙuri, a halin yanzu babu sabis na AI: $error';
  }

  @override
  String shareFailed(String error) {
    return 'An kasa rabawa: _PH_0__';
  }
  ...
  String searchMatchHits(String matchType, int count) {
    return '_PH_0__ · _PH_1__ bugu';
  }

  @override
  String matchCount(int count) {
    return 'Daidaitawa: _PH_0__';
  }

  @override
  String sourceFromNetwork(String source) {
    return 'Tushen: _PH_0__';
  }

  @override
  String get createNew => 'Ƙirƙiri';

  @override
  String micStartFailed(String error) {
    return 'Fara mic ya gaza: _PH_0__';
  }

  @override
  String importResultAccounts(int created, int updated) {
    return 'Lissafi: +$created / sabunta $updated';
  }

  @override
  String importResultDiaries(int created, int updated) {
    return 'Littattafai: +$created / sabunta $updated';
  }

  @override
  String importResultReminders(int created, int updated) {
    return 'Tunatarwa: +$created / sabunta $updated';
  }

  @override
  String importResultSkipped(int count) {
    return 'An tsallake: _PH_0__';
  }

  @override
  String importResultTotal(int count) {
    return 'An canza jimlar: _PH_0__';
  }

  @override
  String get settingsApplied => 'An yi amfani da saituna a madadin.';

  @override
  String get settingsNotApplied => 'Ba a yi amfani da saituna a madadin ba.';

  @override
  String backupExported(String path) {
    return 'An fitar da Ajiyayyen: _PH_0__';
  }

  @override
  String exportFailed(String error) {
    return 'An gaza fitarwa: _PH_0__';
  }

  @override
  String importFailed(String error) {
    return 'An kasa shigo da shi: _PH_0__';
  }
